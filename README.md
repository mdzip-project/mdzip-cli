...
A standalone browser page is available at [markdownzip.org/packager.html](https://markdownzip.org/packager.html). It accepts a dropped or selected folder, builds an `.mdz`, previews the resolved entry-point markdown, and provides a download link for the generated archive.
